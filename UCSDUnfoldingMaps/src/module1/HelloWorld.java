...
public class HelloWorld extends PApplet
{
	...
	public void setup() {
	    ...
	    // for second map
	    //map2.zoomAndPanTo(zoomLevel, new Location(24.89f, -85.49f));
		...
		// for second map
		map2 = new UnfoldingMap(this, 420, 50, 350, 100, provider);
		map2.zoomAndPanTo(zoomLevel, new Location(14.8f, 120.8f));
		MapUtils.createDefaultEventDispatcher(this, map2);
