...
public class EarthquakeCityMap extends PApplet {
	...
	public void setup() {
	    ...
	    if (earthquakes.size() > 0) {
	    	PointFeature p = earthquakes.get(0);
	    	System.out.println(p.getProperties());
	    	Object magObj = p.getProperty("magnitude");
	    ...
	    // Add the markers to the map so that they are displayed
		    ...
		    for(PointFeature f : earthquakes) {
				SimplePointMarker sp = createMarker(f);
				sp.setRadius(10.0f);
				Object mag1 = f.getProperty("magnitude");
				float magnitude = Float.parseFloat(mag1.toString());
				if( magnitude < 4.0f) {
					sp.setColor(blue);
					sp.setRadius(8.0f);
